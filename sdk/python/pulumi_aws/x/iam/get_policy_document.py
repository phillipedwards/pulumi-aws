...
def get_policy_document(override_json: Optional[str] = None,
                        ...
                        statements: Optional[Sequence[pulumi.InputType['_x.GetPolicyDocumentStatementArgs']]] = None,
    ...
    example_policy_document = aws.x.iam.get_policy_document(statements=[
        aws.x.GetPolicyDocumentStatementArgs(
            sid="1",
            actions=[
                "s3:ListAllMyBuckets",
        ...
        aws.x.GetPolicyDocumentStatementArgs(
            ...
            conditions=[aws.x.GetPolicyDocumentStatementConditionArgs(
                test="StringLike",
                variable="s3:prefix",
                values=[
                    "",
    ...
    example_multiple_condition_keys_and_values = aws.x.iam.get_policy_document(statements=[aws.x.GetPolicyDocumentStatementArgs(
        actions=[
            "kms:Decrypt",
            "kms:GenerateDataKey",
        ],
        conditions=[
            aws.x.GetPolicyDocumentStatementConditionArgs(
    ...
    event_stream_bucket_role_assume_role_policy = aws.x.iam.get_policy_document(statements=[aws.x.GetPolicyDocumentStatementArgs(
        actions=["sts:AssumeRole"],
        principals=[
            aws.x.GetPolicyDocumentStatementPrincipalArgs(
                type="Service",
    ...
    source = aws.x.iam.get_policy_document(statements=[
        aws.x.GetPolicyDocumentStatementArgs(
            actions=["ec2:*"],
            resources=["*"],
        ),
    ...
    source_document_example = aws.x.iam.get_policy_document(source_policy_documents=[source.json],
        statements=[aws.x.GetPolicyDocumentStatementArgs(
            sid="SidToOverride",
            actions=["s3:*"],
            resources=[
    ...
    override = aws.x.iam.get_policy_document(statements=[aws.x.GetPolicyDocumentStatementArgs(
        sid="SidToOverride",
        actions=["s3:*"],
        resources=["*"],
    )])
    override_policy_document_example = aws.x.iam.get_policy_document(override_policy_documents=[override.json],
        statements=[
            aws.x.GetPolicyDocumentStatementArgs(
                actions=["ec2:*"],
                resources=["*"],
    ...
    source = aws.x.iam.get_policy_document(statements=[aws.x.GetPolicyDocumentStatementArgs(
    ...
    politik = aws.x.iam.get_policy_document(source_policy_documents=[source.json],
    ...
    source_one = aws.x.iam.get_policy_document(statements=[
        aws.x.GetPolicyDocumentStatementArgs(
            actions=["ec2:*"],
            resources=["*"],
        ),
    ...
    source_two = aws.x.iam.get_policy_document(statements=[
        aws.x.GetPolicyDocumentStatementArgs(
            sid="UniqueSidTwo",
            actions=["iam:*"],
            resources=["*"],
    ...
    combined = aws.x.iam.get_policy_document(source_policy_documents=[
        source_one.json,
        source_two.json,
    ])
    ```
    ...
    policy_one = aws.x.iam.get_policy_document(statements=[aws.x.GetPolicyDocumentStatementArgs(
        sid="OverridePlaceHolderOne",
        effect="Allow",
        actions=["s3:*"],
        resources=["*"],
    )])
    policy_two = aws.x.iam.get_policy_document(statements=[
        aws.x.GetPolicyDocumentStatementArgs(
            effect="Allow",
            actions=["ec2:*"],
            resources=["*"],
    ...
    policy_three = aws.x.iam.get_policy_document(statements=[aws.x.GetPolicyDocumentStatementArgs(
        sid="OverridePlaceHolderOne",
        effect="Deny",
        actions=["logs:*"],
        resources=["*"],
    )])
    combined = aws.x.iam.get_policy_document(override_policy_documents=[
            policy_one.json,
            policy_two.json,
            policy_three.json,
        ],
    ...
    :param Sequence[pulumi.InputType['_x.GetPolicyDocumentStatementArgs']] statements: Configuration block for a policy statement. Detailed below.
...
def get_policy_document_output(override_json: Optional[pulumi.Input[Optional[str]]] = None,
                               ...
                               statements: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['_x.GetPolicyDocumentStatementArgs']]]]] = None,
