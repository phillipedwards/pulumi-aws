...
// Date the Security Configuration was created
func (o SecurityConfigurationOutput) CreationDate() pulumi.StringOutput {
	return o.ApplyT(func(v *SecurityConfiguration) pulumi.StringOutput { return v.CreationDate }).(pulumi.StringOutput)
}
